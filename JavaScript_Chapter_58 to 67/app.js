...
console.log(
  "Node Type of element having id form-content",
  formContentNode.nodeType
);
...
console.log(
  "Child Node of element having id lastName",
  lastNameNode.childNodes
);
...
console.log(
  "First Child of element having id main-content",
  mainContentNode.firstChild
);
console.log(
  "Last Child of element having id main-content",
  mainContentNode.lastChild
);
...
console.log(
  "Previous Siblings of element having id lastName",
  lastNamePreviousSibling
);
